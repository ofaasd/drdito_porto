    ...
    <section class="blog-details-area" id="blog">
        <div class="container">
            ...
            <div class="banner-wrapper">
                <img src="<?php echo e(Storage::url($post->image)); ?>" alt="banner image">
                <!--banner meta content md-->
                <div class="meta-info">
                    <div class="single-meta">
                        <i class="fas fa-user text-white" aria-hidden="true"></i>
                        <h6 class="text">
                            <?php echo e($post->profile->full_name); ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('local-js'); ?>
    <script>
        function copyLink() {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\work\app\dokterdito_app\resources\views/blog/show.blade.php ENDPATH**/ ?>