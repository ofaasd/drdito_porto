...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Fill in the form below to create a new blog post</p>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>"></div>
                            <textarea id="body" name="body" style="display:none;"><?php echo e(old('body')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\work\app\dokterdito_app\resources\views\admin\posts\create.blade.php ENDPATH**/ ?>