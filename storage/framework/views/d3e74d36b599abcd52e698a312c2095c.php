                    ...
                    <div class="hero-content text-center text-md-start">
                        <div class="title_container">
                            <h1 class="hero-title wow animate__animated animate__fadeInUp title_text">
                                <?php echo e($profile->full_name); ?> <?php echo e($profile->titles); ?>
                ...
                <div class="col-md-6 specialty-item" data-specialty-index="<?php echo e($index); ?>">
                    ...
                    <div class="service_card wow animate__animated animate__fadeInUp">
                        <div class="card-header">
                            ...
                            <?php if(!empty($specialty->external_link)): ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="post-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="<?php echo e(asset('assets/img/blog/cover.png')); ?>" width="80%" align="center">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <img src="<?php echo e(asset('assets/img/blog/email.jpeg')); ?>" width="80%" align="center">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="gallery-area section-space" id="gallery">
        <div class="container">
            ...
            <div class="row protfolio-container wow animate__animated animate__fadeInUp g-4">
                <!-- protfolio item -->
                <?php $__currentLoopData = $profile->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-4 grid-item <?php echo e($gallery->category); ?>">
                        <div class="single-protfolio">
                            
                            <img src="<?php echo e($gallery->image); ?>" 
                                class="lazyload img-fluid" 
                                alt="<?php echo e($gallery->title); ?>">
                                
                            <div class="details">
                                <a href="<?php echo e($gallery->link ?? '#'); ?>" class="details-link" aria-label="protfolio single item">
                                    
                                    <h4 class="text-white"><?php echo e($gallery->title); ?></h4>
                                    <p class="text-white"><?php echo e($gallery->description); ?></p>
            ...
            <div class="tab-content  wow animate__animated animate__fadeInUp">
                <div class="tab-pane fade show active" id="work_experience" role="tabpanel" tabindex="0">
                    <div class="row g-4 gx-xxl-5" style="font-size: 8px;">
                        <!-- tab single item -->
                                ...
                                <!-- 1 -->
                                <?php $__currentLoopData = $profile->educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6">
                                     <div class="resume-wrapper">
                                        <div class="resume-content">
                                            <span class="resume-meta">
                                                    <?php echo e($education->start_year); ?> - <?php echo e($education->end_year); ?>

                                            </span>
                                            <h3 class="title">
                                                    <a href=""><?php echo e($education->institution); ?></a>
                                            </h3>
                                            <a href="#" class="institute-name">
                                                <?php echo e($education->field_of_study); ?>
                ...
                <div class="tab-pane fade" id="Academic_qualification" role="tabpanel" tabindex="0">
                    <div class="row g-4 g-xl-5">
                        <!-- tab single item -->
                         <?php $__currentLoopData = $profile->awards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $award): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="resume-wrapper">
                                <div class="resume-content">
                                    <span class="resume-meta">
                                    ...
                                    <h3 class="title">
                                        <a href=""><?php echo e($award->title); ?>, <?php echo e($award->issuer); ?></a>
                                    </h3>
                                    <a href="#!" class="institute-name">
                ...
                <div class="tab-pane fade" id="achievments_qualification" role="tabpanel" tabindex="0">
                    <div class="row g-4 g-xl-5">
                        <!-- tab single item -->
                        <?php $__currentLoopData = $profile->achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $achive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="resume-wrapper">
                                <div class="resume-content">
                                    <span class="resume-meta">
                                        <?php echo e($achive->year); ?>

                                    </span>
                                    <h3 class="title">
                                        <a href=""><?php echo e($achive->title); ?></a>
                                    </h3>
                                    <a href="#!" class="institute-name">
                                        <i><?php echo e($achive->issuer); ?></i>
                                    </a>
                                </div>
                            </div>   
                        </div>
                ...
                <div class="tab-pane fade" id="certifications_qualification" role="tabpanel" tabindex="0">
                    <div class="row g-4 g-xl-5">
                        <!-- tab single item -->
                        <?php $__currentLoopData = $profile->certifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="resume-wrapper">
                                <div class="resume-content">
                                    <h3 class="title">
                                        <a href=""><?php echo e($certification->name); ?></a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-md-6 mb-4">
                                <div class="resume-wrapper h-100">
                                    <div class="resume-content">
                                        <span class="resume-meta">
                                            <i class="bi bi-calendar3"></i> <?php echo e($book->year ?? 'Tahun tidak diketahui'); ?>

                                        </span>
                                        
                                        <h3 class="title">
                                            <a href="<?php echo e($book->link ?? '#!'); ?>" <?php echo e($book->link ? 'target="_blank"' : ''); ?>>
                                                <?php echo e($book->title); ?>

                                            </a>
                                        </h3>
                                        
                                        <?php if($book->publisher_or_journal): ?>
                                            <div class="publisher-info text-muted mb-2" style="font-size: 0.9rem;">
                                                <i class="bi bi-journal-bookmark"></i> <?php echo e($book->publisher_or_journal); ?>
                                        ...
                                        <a href="#!" class="institute-name" style="cursor: default;">
                                            <i class="bi bi-pen"></i> 
                                            <?php echo preg_replace('/(Anurogo,?\s*D\.?)/i', '<strong>$1</strong>', $book->authors); ?>

                                        </a>
                                        <br /><br />
                                        <?php if(!empty($book->link)): ?>
                                            <a href="<?php echo e($book->link); ?>" class="btn-primary-gradient" target="_blank">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $publications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-md-6 mb-4">
                                <div class="resume-wrapper h-100">
                                    <div class="resume-content">
                                        <span class="resume-meta">
                                            <i class="bi bi-calendar3"></i> <?php echo e($pub->year ?? 'Tahun tidak diketahui'); ?>

                                        </span>
                                        
                                        <h3 class="title">
                                            <a href="<?php echo e($pub->link ?? '#!'); ?>" <?php echo e($pub->link ? 'target="_blank"' : ''); ?>>
                                                <?php echo e($pub->title); ?>

                                            </a>
                                        </h3>
                                        
                                        <?php if($pub->publisher_or_journal): ?>
                                            <div class="publisher-info text-muted mb-2" style="font-size: 0.9rem;">
                                                <i class="bi bi-journal-bookmark"></i> <?php echo e($pub->publisher_or_journal); ?>
                                        ...
                                        <a href="#!" class="institute-name" style="cursor: default;">
                                            <i class="bi bi-pen"></i> 
                                            <?php echo preg_replace('/(Anurogo,?\s*D\.?)/i', '<strong>$1</strong>', $pub->authors); ?>

                                        </a>
                                        <br /><br />
                                        <?php if(!empty($pub->link)): ?>
                                            <a href="<?php echo e($pub->link); ?>" class="btn-primary-gradient" target="_blank">
                ...
                <div class="tab-pane fade" id="experiences" role="tabpanel" tabindex="0">
                    <div class="row g-4 g-xl-5">
                        <!-- tab single item -->
                         <?php $__currentLoopData = $profile->experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="resume-wrapper">
                                <div class="resume-content">
                                    <span class="resume-meta">
                                    ...
                                    <h3 class="title">
                                        <a href=""><?php echo e($exp->position); ?> <br />(<?php echo e($exp->company); ?>)</a> 
                                    </h3>
                                    
                                    <a href="#!" class="institute-name">
                                        <?php echo e($exp->start_date); ?> - <?php echo e($exp->end_date); ?>
